...
<div>
  ...
  <div v-if="files.length === 0" class="dropzone p-12 text-center" :class="{ active: dragging }"
    ...
    <div @click="$refs.batchInput.click()" class="cursor-pointer">
  ...
  <div v-else class="space-y-6">
    <div class="flex items-center gap-4 flex-wrap">
      <button @click="$refs.batchInput.click()" class="btn btn-ghost">
  ...
  computed: {
    progressPercent() {
      ...
      return (this.currentIndex / this.files.length) * 100;
    },
  },
  methods: {
    classBadge(cls) {
    ...
    async startBatch() {
      ...
      this.running = false;
      this.finished = !this.stopRequested;
    },
    stopBatch() {
