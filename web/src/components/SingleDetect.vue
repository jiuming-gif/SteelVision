...
<div>
  ...
  <div v-else class="space-y-6">
    ...
    <div class="flex items-center gap-4">
      <button @click="fileInput.click()" class="btn btn-ghost">
...
async function startDetection() {
  ...
  try {
    ...
    result.value = {
      ...
      detected_classes: parseClasses(data.detection_result),
...
function parseClasses(resultStr) {
